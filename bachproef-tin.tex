...
\lstdefinelanguage{JavaScript}{
  keywords={typeof, then, new, true, false, catch, function, return, null, catch, switch, var, if, in, while, do, else, case, break, interval, mapTo, fromEvent, subscribe},
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={class, export, boolean, throw, implements, import, this, promise, Observable, Rx},
