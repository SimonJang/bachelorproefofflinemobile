...
Er is voor SQS gekozen omdat SNS een push strategie voor zijn berichten hanteert. Indien er bij de synchronisatie een fout voorvalt, dan is het bericht onherroepelijk verloren. Met SQS moeten de boodschappen expliciet worden verwijderd. Wanneer de afhandeling van een bericht meerdere keren zou falen, dan komt de  terecht in de 'dead letter queue'. Afhankelijk van de configuratie van die 'dead letter queue' blijft het bericht nog 30 dagen bestaan. De berichten in de 'dead letter queue' kunnen dan nog altijd manueel worden verwerkt.
